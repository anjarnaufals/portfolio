...
List<LatestWork> latestWork = const [
  LatestWork(
    ...
    work: Work(
      ...
      descriptionRole: [
        ...
        "Implementing a clean code architecture using the Bloc pattern with adjustments for application scalability, aiming to facilitate easymodifications.",
  ...
  LatestWork(
    ...
    work: Work(
      ...
      descriptionRole: [
        ...
        "Contribute to securing the env file using the envied package's method to prevent information leakage from APK file extraction.",
      ],
    ),
    storeUrl:
  ...
  LatestWork(
    ...
    work: Work(
      ...
      descriptionRole: [
        "Translating UI/UX Figma design into Flutter code to ensure the application appears as expected.",
        "Implementing a clean code architecture using the Getx pattern with adjustments for application scalability, aiming to facilitate easymodifications.",
        "Integrating the REST API from the backend team to ensure all features function properly",
        "Creating and developing several agreed-upon features with the aim of making the application function properly.",
        "Implementing custom widgets for reusability purposes, aiming to avoid code duplication.",
      ],
