...
//inkare section
const String anggoApp = "Anggo App";
const String nusaRitel = "Nusa Ritel";
const String fdsMobile = "FDS Mobile";
const String khudiAI = "Khudi AI";
const String chargeIon = "Charge Ion";
const String banom = "Banom";
const String miftahulHuda = "Miftahul Huda";
